...
export const UI_STRINGS = (function getLocalization() {
   return {
      ...
      controls_mouse_wheel: {en: "Mouse wheel changes CV chapters", ru: "Колесо мыши - перемещение по резюме", kr: "마우스 휠으로 이력서 부분을 바꿀 수 있어요"},
      controls_mouse_move: {en: "Mouse movement rotates 3D scene", ru: "Движение мыши - поворот в 3D сцене", kr: "마우스 움직이로 3D 그래픽 컨트롤할 수 있어요"},
      controls_close: { en: "Gotcha 🚀", ru: "Понятно 🚀", kr: "알겠어 🚀" },
      controls_fullscreen_key: { en: "For fullscreen press F11 or click such pictogram", ru: "Нажатие на клавишу F11 или такую пиктограмму - полноэкранный режим", kr: "F11 버튼과 이 그림 문자으로 화면 극대화할 수 있어요" },
