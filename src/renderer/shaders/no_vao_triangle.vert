...
void main(void) {
   ...
   NDC_COORDS[6] = vec4(-0.5, -0.5, 0.0, 1.0);
   NDC_COORDS[7] = vec4(-1.0,  0.5, 0.0, 1.0);
   NDC_COORDS[8] = vec4( 0.0,  0.5, 0.0, 1.0);
   NDC_COORDS[9] = vec4(-0.5, -0.5, 0.0, 1.0);
   NDC_COORDS[10] = vec4(0.5, -0.5, 0.0, 1.0);
   NDC_COORDS[11] = vec4(0.0, -1.0, 0.0, 1.0);
   vec4 COLORS[3];
